<%-- 
    ...
    Created on : 25-11-2019, 14:24:31
    Author     : HP
--%>
                        ...
                        <div class="page-body">
                              <div class="wrapper">
                                <form class="form-signin" method="POST" action="Proceso">       
                                  ...
                                  <input type="text"  class="form-control" name="apellidoPaterno" required="" placeholder="Apellido Paterno" autofocus="">
                                  <input type="text" class="form-control" name="apellidoMaterno" required="" placeholder="Apellido Materno" autofocus="">
                                  <select>
                                      <option value="">Seleccione profesion</option>
                                  </select>
                                  <input type="clave" class="form-control" name="password" placeholder="Password" required=""/>      
